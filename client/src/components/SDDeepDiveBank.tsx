...
// IC5/IC6/IC7 level questions for each of 8 core components.
  ...
  return (
    <div className="space-y-5">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-purple-700 mt-1 leading-relaxed">
              IC5 questions test component mechanics. IC6 questions test production failure modes and real experience.
              IC7 questions test novel insights and cross-system implications. Find your current level — then see exactly what to learn to reach the next one.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2">
        ...
        {(["All", "IC5", "IC6", "IC7"] as const).map(level => (
          <button
            key={level}
            onClick={() => setSelectedLevel(level)}
            className={`text-[11px] font-bold px-2.5 py-1 rounded-lg border transition-all ${
              level === selectedLevel
                ? level === "IC5" ? "bg-blue-600 text-white border-blue-600"
                : level === "IC6" ? "bg-amber-600 text-white border-amber-600"
                : level === "IC7" ? "bg-purple-600 text-white border-purple-600"
                : "bg-gray-900 text-white border-gray-900"
                : "bg-white text-gray-600 border-gray-200 hover:border-gray-400"
            }`}
          >
