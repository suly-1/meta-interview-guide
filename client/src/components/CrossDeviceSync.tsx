...
export default function CrossDeviceSync() {
  ...
  const handleRestore = async () => {
    ...
    try {
      ...
      if (!data) {
        toast.error(
          "No data found for that sync code. Check the code and try again."
        );
        return;
      }
  ...
  const handleNewCode = () => {
    ...
    localStorage.setItem(SYNC_CODE_KEY, code);
    toast.success(
      "New sync code generated. Click Save to upload your progress."
    );
  };
              ...
              <>
                <div className="flex items-start gap-2 p-3 rounded-lg bg-blue-500/10 border border-blue-500/20">
                  ...
                  <p className="text-xs text-blue-300/80">
                    Save your progress to the cloud with a unique sync code. Use
                    this code on any device to restore your ratings, notes, mock
                    history, and more.
                  </p>
                </div>
                ...
                {syncCode ? (
                  <div className="space-y-3">
                    ...
                    <p className="text-xs text-muted-foreground text-center">
                      Write this code down — you'll need it to restore on
                      another device.
                    </p>
                  ...
                  >
                    ...
                    {pushing
                      ? "Generating code & saving…"
                      : "Generate Sync Code & Save"}
                  </button>
                )}
              </>
            ) : (
              <>
                <div className="flex items-start gap-2 p-3 rounded-lg bg-emerald-500/10 border border-emerald-500/20">
                  ...
                  <p className="text-xs text-emerald-300/80">
                    Enter your sync code to restore progress from another
                    device. This will overwrite your current local data.
                  </p>
                </div>
