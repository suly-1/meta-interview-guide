...
import { ICLevelSignalCalibrator } from "@/components/ICLevelSignalCalibrator";
import { MetaProductDesignSimulator } from "@/components/MetaProductDesignSimulator";
...
export default function SystemDesignTab() {
  ...
  return (
    <div className="space-y-5">
      ...
      {/* Priority #2: IC-Level Signal Calibrator */}
      <ICLevelSignalCalibrator />

      {/* Priority #3: Meta Product Design Simulator */}
