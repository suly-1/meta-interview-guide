  ...
  return (
    <>
      ...
      >
        ...
        <kbd className="hidden sm:inline px-1 py-0.5 rounded bg-background border border-border text-[9px] font-mono">
          ⌘K
        </kbd>
      </button>
          ...
          >
            ...
            <div className="flex items-center gap-3 px-4 py-3 border-b border-border">
              ...
              <div className="flex items-center gap-1.5">
                <kbd className="px-1.5 py-0.5 rounded bg-secondary border border-border text-[10px] font-mono text-muted-foreground">
                  ESC
                </kbd>
                <button
                  onClick={handleClose}
              ...
              <div className="max-h-80 overflow-y-auto">
                {results.length === 0 ? (
                  ...
                  results.map((result, i) => (
                    ...
                    >
                      <span className={`shrink-0 ${result.color}`}>
                        {result.icon}
                      </span>
