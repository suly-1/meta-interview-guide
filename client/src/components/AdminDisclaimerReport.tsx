                    ...
                    filtered.map((row, i) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3 text-muted-foreground whitespace-nowrap text-xs">
                          {row.acknowledged ? (
                            <span className="text-emerald-400" title={formatDate(row.acknowledgedAt)}>
                              {relativeTime(row.acknowledgedAt)}
                              <span className="ml-1 text-emerald-400/50">({formatDate(row.acknowledgedAt)})</span>
                            </span>
                          ) : (
