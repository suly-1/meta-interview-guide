...
export default function AdminPinGate({ children }: AdminPinGateProps) {
  ...
  const pinStatus = trpc.auth.getPinStatus.useQuery(undefined, {
    enabled: !unlocked,
    refetchOnWindowFocus: false,
  });

  useEffect(() => {
    if (pinStatus.data?.locked && pinStatus.data.lockoutUntil) {
      setLockoutUntil(new Date(pinStatus.data.lockoutUntil));
    }
  }, [pinStatus.data]);
