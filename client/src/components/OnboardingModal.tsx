...
const STEPS = [
  ...
  {
    title: "Coding Tab",
    body: "20 patterns with quick drills, spaced repetition, a mock interview timer, and Anki export. Use the Weak Spots filter to focus on patterns you've rated ★1–2.",
    icon: "💻",
  },
  {
    title: "Behavioral Tab",
    body: "28 questions across 7 focus areas. Practice Mode gives you a 3-minute timer per question. Full Mock simulates a real 4-question behavioral interview.",
    icon: "🧠",
  },
  {
    title: "✦ AI Native Tab",
      ...
      <div className="prep-card w-full max-w-md p-6 relative">
        ...
        <div className="flex gap-1.5 mb-5">
          {STEPS.map((_, i) => (
            <div
              key={i}
              className={`h-1 flex-1 rounded-full transition-all ${i <= step ? "bg-blue-500" : "bg-secondary"}`}
            />
          ))}
        </div>
