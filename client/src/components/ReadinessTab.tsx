      ...
      <div ref={printRef} style={{ display: "none" }}>
        <div style={{ marginBottom: 16, borderBottom: "2px solid #111827", paddingBottom: 12, display: "flex", justifyContent: "space-between", alignItems: "flex-end" }}>
          <div>
            ...
            <p style={{ color: "#6b7280", fontSize: 11, marginTop: 4 }}>Staff Engineer Interview Guide — FAANG Edition</p>
          </div>
        ...
        <div className="footer">
          Generated by Staff Engineer Interview Guide — FAANG Edition · {today} · All data from localStorage
        </div>
      </div>
    </div>
  );
