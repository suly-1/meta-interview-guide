...
export const PREP_TIMELINE = [
  {
    ...
    focus: "Foundation",
    items: [
      "Complete NeetCode patterns 1–7 (arrays, strings, trees)",
      "Set up behavioral story bank (6 core stories)",
      "Read DDIA chapters 1–5",
    ],
  },
  {
    week: "Weeks 3–4",
    focus: "Depth",
    items: [
      "Complete NeetCode patterns 8–14 (graphs, DP, heaps)",
      "Practice 2 system design problems end-to-end",
      "Refine behavioral stories with STAR format",
    ],
  },
  {
    week: "Weeks 5–6",
    focus: "Speed",
    items: [
      "Timed coding sessions (35 min per problem)",
      "Mock system design with a peer",
      "Full behavioral mock (record yourself)",
    ],
  },
  {
    week: "Week 7",
    focus: "Simulation",
    items: [
      "Full mock interview day (coding + design + behavioral)",
      "Review weak patterns — focus drill mode",
  ...
  },
  {
    ...
    focus: "Final Polish",
    items: [
      "Light coding maintenance (2–3 problems/day)",
      "Review all STAR stories aloud",
      "Logistics: CoderPad setup, time zone, quiet space",
    ],
  },
];
